...
HOUSE_EDGE = float(os.getenv("HOUSE_EDGE") or "0.12")
MIN_BET = 50
SHOP_MARKUP = 1.35
...
CASES = {
    ...
    'star_case_1': {'name': '⭐ STAR CASE I', 'price': 55, 'category': 'stars', 'icon': '⭐', 'color': 'c-starter', 'star_drops': [5, 15, 25, 35, 40, 55, 70, 100], 'star_weights': [48, 30, 18, 10, 7, 4, 2, 1], 'desc': '8 дропов 5–100⭐'},
    'star_case_2': {'name': '⭐ STAR CASE II', 'price': 110, 'category': 'stars', 'icon': '✨', 'color': 'c-starter', 'star_drops': [10, 25, 40, 60, 80, 120, 180, 250], 'star_weights': [48, 30, 18, 10, 7, 4, 2, 1], 'desc': '10–250⭐'},
    'star_case_3': {'name': '⭐ STAR CASE III', 'price': 280, 'category': 'stars', 'icon': '🌟', 'color': 'c-pepe', 'star_drops': [25, 50, 100, 150, 200, 350, 500, 800], 'star_weights': [48, 30, 18, 10, 7, 4, 2, 1], 'desc': '25–800⭐'},
    'star_case_4': {'name': '⭐ STAR CASE IV', 'price': 550, 'category': 'stars', 'icon': '💫', 'color': 'c-tg', 'star_drops': [50, 100, 200, 300, 450, 700, 1000, 1500], 'star_weights': [48, 30, 18, 10, 7, 4, 2, 1], 'desc': '50–1500⭐'},
    'nft_starter': {'name': '🌱 NFT STARTER', 'price': 220, 'category': 'nft', 'icon': '🌱', 'color': 'c-starter', 'rarities': ['Common', 'Uncommon', 'Rare'], 'weights': [62, 30, 8], 'min_stars': 15, 'max_stars': 60, 'stars_chance': 0.2, 'force_names': ['Мишка', 'Сердце', 'Конфета', 'Подарок', 'Ракета', 'Букет', 'Кольцо', 'Triple Meow'], 'desc': 'Чаще 15–100⭐, редко Meow'},
    'nft_candy': {'name': '🍭 CANDY NFT', 'price': 400, 'category': 'nft', 'icon': '🍭', 'color': 'c-pepe', 'rarities': ['Uncommon', 'Rare', 'Epic'], 'weights': [62, 30, 8], 'min_stars': 30, 'max_stars': 100, 'stars_chance': 0.18, 'force_names': ['Конфета', 'Candy Cane', 'Lol Pop', 'Berry Box', 'Cookie Heart', 'Whip Cupcake', 'Love Potion', 'Jelly Bunny', 'Spy Agaric'], 'desc': 'Сладкое · EV < цена, иногда 500+'},
    'nft_pepe': {'name': '🐸 PEPE BOX', 'price': 650, 'category': 'nft', 'icon': '🐸', 'color': 'c-pepe', 'rarities': ['Rare', 'Epic', 'Legendary'], 'weights': [62, 30, 8], 'min_stars': 40, 'max_stars': 150, 'stars_chance': 0.15, 'force_names': ['Мишка', 'Ракета', 'Букет', 'Кольцо', 'Алмаз', 'Jelly Bunny', 'Spy Agaric', 'Kissed Frog', 'Toy Bear'], 'desc': 'Чаще 15–100, редко топ'},
    'nft_magic': {'name': '🔮 MAGIC VAULT', 'price': 1000, 'category': 'nft', 'icon': '🔮', 'color': 'c-frag', 'rarities': ['Rare', 'Epic', 'Legendary'], 'weights': [62, 30, 8], 'min_stars': 60, 'max_stars': 250, 'stars_chance': 0.12, 'force_names': ['Мишка', 'Ракета', 'Кольцо', 'Hex Pot', 'Spy Agaric', 'Flying Broom', 'Crystal Ball', 'Love Potion', 'Eternal Rose', 'Genie Lamp', 'Magic Potion'], 'desc': 'Чаще 15–100, редко Magic Potion'},
    'brand_gucci': {'name': '👜 GUCCI DROP', 'price': 900, 'category': 'brands', 'icon': '👜', 'color': 'c-tg', 'rarities': ['Epic', 'Legendary'], 'weights': [72, 28], 'min_stars': 80, 'max_stars': 300, 'stars_chance': 0.18, 'force_names': ['Candy Cane', 'Bow Tie', 'Snoop Dogg', 'Top Hat', 'Swag Bag', 'Diamond Ring', 'Swiss Watch'], 'desc': 'От 300⭐ · редко Swiss'},
    'brand_rolex': {'name': '⌚ ROLEX CASE', 'price': 1350, 'category': 'brands', 'icon': '⌚', 'color': 'c-frag', 'rarities': ['Epic', 'Legendary', 'Mythic'], 'weights': [62, 30, 8], 'min_stars': 100, 'max_stars': 400, 'stars_chance': 0.15, 'force_names': ['Top Hat', 'Bow Tie', 'Diamond Ring', 'Signet Ring', 'Vintage Cigar', 'Swiss Watch', 'Gem Signet'], 'desc': 'Чаще среднее, редко Swiss Watch'},
    'brand_snoop': {'name': '🐕 SNOOP DROP', 'price': 800, 'category': 'brands', 'icon': '🐕', 'color': 'c-pepe', 'rarities': ['Rare', 'Epic', 'Legendary'], 'weights': [62, 30, 8], 'min_stars': 60, 'max_stars': 250, 'stars_chance': 0.18, 'force_names': ['Candy Cane', 'Snoop Dogg', 'Swag Bag', 'Snoop Cigar', 'Top Hat', 'Vintage Cigar', 'Low Rider'], 'desc': 'От 300⭐ · редко Low Rider'},
    'only_onyx': {'name': '🖤 ONYX BLACK', 'price': 1700, 'category': 'only_nft', 'icon': '🖤', 'color': 'c-durov', 'rarities': ['Epic', 'Legendary'], 'weights': [72, 28], 'stars_chance': 0.0, 'force_names': ['Candy Cane', 'Lol Pop', 'Evil Eye', 'Skull Flower', 'Top Hat', 'Electric Skull', 'Neko Helmet', 'Voodoo Doll'], 'desc': 'От 300⭐ · редко Neko/Voodoo'},
    'only_crystal': {'name': '💎 CRYSTAL VAULT', 'price': 2300, 'category': 'only_nft', 'icon': '💎', 'color': 'c-frag', 'rarities': ['Epic', 'Legendary', 'Mythic'], 'weights': [62, 30, 8], 'stars_chance': 0.0, 'force_names': ['Spy Agaric', 'Cookie Heart', 'Crystal Ball', 'Flying Broom', 'Diamond Ring', 'Ion Gem', 'Mini Oscar'], 'desc': 'От 300⭐ · редко Oscar'},
    'only_durov': {'name': '🧢 DUROV ONLY', 'price': 4000, 'category': 'only_nft', 'icon': '🧢', 'color': 'c-durov', 'rarities': ['Legendary', 'Mythic'], 'weights': [72, 28], 'stars_chance': 0.0, 'force_names': ['Top Hat', 'Crystal Ball', "Khabib's Papakha", 'Diamond Ring', 'Mini Oscar', 'Heroic Helmet', 'Precious Peach'], 'desc': 'Чаще среднее, микро Pepe/Cap'},
    ...
    'rich_gold': {'name': '👑 GOLD RICH', 'price': 1350, 'category': 'rich', 'icon': '👑', 'color': 'c-durov', 'rarities': ['Epic', 'Legendary', 'Mythic'], 'weights': [62, 30, 8], 'min_stars': 200, 'max_stars': 800, 'stars_chance': 0.12, 'force_names': ['Candy Cane', 'Snoop Dogg', 'Evil Eye', 'Top Hat', 'Crystal Ball', 'Diamond Ring', 'Swiss Watch'], 'desc': 'От 300⭐ · редко Swiss'},
    'rich_diamond': {'name': '💎 DIAMOND RICH', 'price': 2850, 'category': 'rich', 'icon': '💎', 'color': 'c-frag', 'rarities': ['Legendary', 'Mythic'], 'weights': [72, 28], 'min_stars': 400, 'max_stars': 1500, 'stars_chance': 0.1, 'force_names': ['Evil Eye', 'Top Hat', 'Crystal Ball', 'Diamond Ring', 'Swiss Watch', 'Mini Oscar', 'Ion Gem'], 'desc': 'От 300⭐ · редко Ion'},
    'rich_mythic': {'name': '☄️ MYTHIC RICH', 'price': 5750, 'category': 'rich', 'icon': '☄️', 'color': 'c-durov', 'rarities': ['Legendary', 'Mythic'], 'weights': [72, 28], 'min_stars': 800, 'max_stars': 3000, 'stars_chance': 0.08, 'force_names': ['Top Hat', 'Crystal Ball', 'Flying Broom', 'Diamond Ring', 'Swiss Watch', 'Mini Oscar', 'Ion Gem', 'Heroic Helmet'], 'desc': 'От 300⭐ · редко Helmet'},
...
def roll_crash_point() -> float:
    r = random.random()
    # ~6% мгновенный краш, фактор 0.90 → house ~10%+
    if r < 0.06:
        return 1.0
    p = max(1.01, 0.90 / (1 - r))
...
def mines_mult(mines: int, opened: int) -> float:
    ...
    for i in range(opened):
        ...
        if safe <= 0:
            break
        mult *= remaining / safe
    return max(1.0, mult * (1 - max(HOUSE_EDGE, 0.12)))
