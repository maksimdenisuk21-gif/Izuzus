...
ALLOW_DEV_AUTH = os.getenv("ALLOW_DEV_AUTH", "0") not in ("0", "false", "False")
...
CASES = {
    ...
    'star_case_1': {'name': '⭐ STAR CASE I', 'price': 55, 'category': 'stars', 'icon': '⭐', 'color': 'c-starter', 'star_drops': [5, 15, 25, 35, 40, 55, 70, 100], 'star_weights': [40, 28, 20, 14, 10, 7, 5, 4], 'desc': '8 дропов 5–100⭐'},
    'star_case_2': {'name': '⭐ STAR CASE II', 'price': 110, 'category': 'stars', 'icon': '✨', 'color': 'c-starter', 'star_drops': [10, 25, 40, 60, 80, 120, 180, 250], 'star_weights': [40, 28, 20, 14, 10, 7, 5, 4], 'desc': '10–250⭐'},
    'star_case_3': {'name': '⭐ STAR CASE III', 'price': 280, 'category': 'stars', 'icon': '🌟', 'color': 'c-pepe', 'star_drops': [25, 50, 100, 150, 200, 350, 500, 800], 'star_weights': [40, 28, 20, 14, 10, 7, 5, 4], 'desc': '25–800⭐'},
    'star_case_4': {'name': '⭐ STAR CASE IV', 'price': 550, 'category': 'stars', 'icon': '💫', 'color': 'c-tg', 'star_drops': [50, 100, 200, 300, 450, 700, 1000, 1500], 'star_weights': [40, 28, 20, 14, 10, 7, 5, 4], 'desc': '50–1500⭐'},
    'nft_starter': {'name': '🌱 NFT STARTER', 'price': 220, 'category': 'nft', 'icon': '🌱', 'color': 'c-starter', 'rarities': ['Common', 'Uncommon', 'Rare'], 'weights': [55, 35, 10], 'min_stars': 15, 'max_stars': 60, 'stars_chance': 0.2, 'force_names': ['Мишка', 'Сердце', 'Конфета', 'Подарок', 'Ракета', 'Букет', 'Кольцо', 'Triple Meow'], 'desc': 'Чаще 15–100⭐, редко Meow'},
    'nft_candy': {'name': '🍭 CANDY NFT', 'price': 400, 'category': 'nft', 'icon': '🍭', 'color': 'c-pepe', 'rarities': ['Uncommon', 'Rare', 'Epic'], 'weights': [55, 35, 10], 'min_stars': 30, 'max_stars': 100, 'stars_chance': 0.18, 'force_names': ['Конфета', 'Candy Cane', 'Lol Pop', 'Berry Box', 'Cookie Heart', 'Whip Cupcake', 'Love Potion', 'Jelly Bunny', 'Spy Agaric'], 'desc': 'Сладкое · EV < цена, иногда 500+'},
    'nft_pepe': {'name': '🐸 PEPE BOX', 'price': 650, 'category': 'nft', 'icon': '🐸', 'color': 'c-pepe', 'rarities': ['Rare', 'Epic', 'Legendary'], 'weights': [55, 35, 10], 'min_stars': 40, 'max_stars': 150, 'stars_chance': 0.15, 'force_names': ['Мишка', 'Ракета', 'Букет', 'Кольцо', 'Алмаз', 'Jelly Bunny', 'Spy Agaric', 'Kissed Frog', 'Toy Bear'], 'desc': 'Чаще 15–100, редко топ'},
    'nft_magic': {'name': '🔮 MAGIC VAULT', 'price': 1000, 'category': 'nft', 'icon': '🔮', 'color': 'c-frag', 'rarities': ['Rare', 'Epic', 'Legendary'], 'weights': [55, 35, 10], 'min_stars': 60, 'max_stars': 250, 'stars_chance': 0.12, 'force_names': ['Мишка', 'Ракета', 'Кольцо', 'Hex Pot', 'Spy Agaric', 'Flying Broom', 'Crystal Ball', 'Love Potion', 'Eternal Rose', 'Genie Lamp', 'Magic Potion'], 'desc': 'Чаще 15–100, редко Magic Potion'},
    'brand_gucci': {'name': '👜 GUCCI DROP', 'price': 900, 'category': 'brands', 'icon': '👜', 'color': 'c-tg', 'rarities': ['Epic', 'Legendary'], 'weights': [65, 35], 'min_stars': 80, 'max_stars': 300, 'stars_chance': 0.18, 'force_names': ['Candy Cane', 'Bow Tie', 'Snoop Dogg', 'Top Hat', 'Swag Bag', 'Diamond Ring', 'Swiss Watch'], 'desc': 'От 300⭐ · редко Swiss'},
    'brand_rolex': {'name': '⌚ ROLEX CASE', 'price': 1350, 'category': 'brands', 'icon': '⌚', 'color': 'c-frag', 'rarities': ['Epic', 'Legendary', 'Mythic'], 'weights': [55, 35, 10], 'min_stars': 100, 'max_stars': 400, 'stars_chance': 0.15, 'force_names': ['Top Hat', 'Bow Tie', 'Diamond Ring', 'Signet Ring', 'Vintage Cigar', 'Swiss Watch', 'Gem Signet'], 'desc': 'Чаще среднее, редко Swiss Watch'},
    'brand_snoop': {'name': '🐕 SNOOP DROP', 'price': 800, 'category': 'brands', 'icon': '🐕', 'color': 'c-pepe', 'rarities': ['Rare', 'Epic', 'Legendary'], 'weights': [55, 35, 10], 'min_stars': 60, 'max_stars': 250, 'stars_chance': 0.18, 'force_names': ['Candy Cane', 'Snoop Dogg', 'Swag Bag', 'Snoop Cigar', 'Top Hat', 'Vintage Cigar', 'Low Rider'], 'desc': 'От 300⭐ · редко Low Rider'},
    'only_onyx': {'name': '🖤 ONYX BLACK', 'price': 1700, 'category': 'only_nft', 'icon': '🖤', 'color': 'c-durov', 'rarities': ['Epic', 'Legendary'], 'weights': [65, 35], 'stars_chance': 0.0, 'force_names': ['Candy Cane', 'Lol Pop', 'Evil Eye', 'Skull Flower', 'Top Hat', 'Electric Skull', 'Neko Helmet', 'Voodoo Doll'], 'desc': 'От 300⭐ · редко Neko/Voodoo'},
    'only_crystal': {'name': '💎 CRYSTAL VAULT', 'price': 2300, 'category': 'only_nft', 'icon': '💎', 'color': 'c-frag', 'rarities': ['Epic', 'Legendary', 'Mythic'], 'weights': [55, 35, 10], 'stars_chance': 0.0, 'force_names': ['Spy Agaric', 'Cookie Heart', 'Crystal Ball', 'Flying Broom', 'Diamond Ring', 'Ion Gem', 'Mini Oscar'], 'desc': 'От 300⭐ · редко Oscar'},
    'only_durov': {'name': '🧢 DUROV ONLY', 'price': 4000, 'category': 'only_nft', 'icon': '🧢', 'color': 'c-durov', 'rarities': ['Legendary', 'Mythic'], 'weights': [65, 35], 'stars_chance': 0.0, 'force_names': ['Top Hat', 'Crystal Ball', "Khabib's Papakha", 'Diamond Ring', 'Mini Oscar', 'Heroic Helmet', 'Precious Peach'], 'desc': 'Чаще среднее, микро Pepe/Cap'},
    ...
    'rich_gold': {'name': '👑 GOLD RICH', 'price': 1350, 'category': 'rich', 'icon': '👑', 'color': 'c-durov', 'rarities': ['Epic', 'Legendary', 'Mythic'], 'weights': [55, 35, 10], 'min_stars': 200, 'max_stars': 800, 'stars_chance': 0.12, 'force_names': ['Candy Cane', 'Snoop Dogg', 'Evil Eye', 'Top Hat', 'Crystal Ball', 'Diamond Ring', 'Swiss Watch'], 'desc': 'От 300⭐ · редко Swiss'},
    'rich_diamond': {'name': '💎 DIAMOND RICH', 'price': 2850, 'category': 'rich', 'icon': '💎', 'color': 'c-frag', 'rarities': ['Legendary', 'Mythic'], 'weights': [65, 35], 'min_stars': 400, 'max_stars': 1500, 'stars_chance': 0.1, 'force_names': ['Evil Eye', 'Top Hat', 'Crystal Ball', 'Diamond Ring', 'Swiss Watch', 'Mini Oscar', 'Ion Gem'], 'desc': 'От 300⭐ · редко Ion'},
    'rich_mythic': {'name': '☄️ MYTHIC RICH', 'price': 5750, 'category': 'rich', 'icon': '☄️', 'color': 'c-durov', 'rarities': ['Legendary', 'Mythic'], 'weights': [65, 35], 'min_stars': 800, 'max_stars': 3000, 'stars_chance': 0.08, 'force_names': ['Top Hat', 'Crystal Ball', 'Flying Broom', 'Diamond Ring', 'Swiss Watch', 'Mini Oscar', 'Ion Gem', 'Heroic Helmet'], 'desc': 'От 300⭐ · редко Helmet'},
    'rich_durov': {'name': '🔥 DUROV RICH', 'price': 9200, 'category': 'rich', 'icon': '🔥', 'color': 'c-durov', 'rarities': ['Mythic'], 'weights': [100], 'min_stars': 1500, 'max_stars': 8000, 'stars_chance': 0.05, 'force_names': ['Crystal Ball', 'Diamond Ring', 'Swiss Watch', 'Mini Oscar', 'Ion Gem', 'Heroic Helmet', 'Precious Peach', "Durov's Cap"], 'desc': 'От 300⭐ · микро Cap'},
...
async def upgrade(body: UpgradeRequest, authorization: Optional[str] = Header(None), x_telegram_init_data: Optional[str] = Header(None, alias="X-Telegram-Init-Data")):
    ...
    try:
        ...
        iv, tv = int(item.get("value") or 0), int(body.target_value)
        if iv <= 0 or iv >= tv:
            raise HTTPException(400, "Цель должна быть дороже")
        target = find_gift(body.target_name or "") if body.target_name else None
        if not target:
            cands = [gift_public(x) for x in GIFTS_FLAT if int(x.get("value",0)) == tv]
            target = cands[0] if cands else gift_public({"name": body.target_name or "Target", "value": tv, "rarity": "Rare"})
        chance = max(1.0, min(95.0, calc_upgrade_chance(iv, tv, u.get("chance_bonus") or 0)))
        success = random.random() * 100 < chance
        u["inventory"].pop(body.item_index)
        u["games"] += 1
        if success:
            u["wins"] += 1
            ni = {k: target[k] for k in ("name","value","rarity","sn","emoji","img") if k in target}
            ni["id"] = uuid.uuid4().hex[:10]
            u["inventory"].append(ni)
            await add_history(u["tg_id"], "upgrade", "win", f"{item.get('name')} → {target.get('name')}", tv)
            await push_live(ni, u["username"])
            result_target = ni
        else:
            await add_history(u["tg_id"], "upgrade", "lose", f"{item.get('name')} сгорел", 0)
            result_target = None
        await save_user(u)
        return {"success": success, "chance": chance, "balance": u["balance"], "target": result_target, "inventory": u["inventory"]}
    finally:
        ACTIVE_ACTIONS.discard(key)
...
async def open_case(body: CaseOpenRequest, authorization: Optional[str] = Header(None), x_telegram_init_data: Optional[str] = Header(None, alias="X-Telegram-Init-Data")):
    u = await current_user(authorization, x_telegram_init_data)
    key = (u["tg_id"], "case", body.case_id)
    if key in ACTIVE_ACTIONS:
        raise HTTPException(409, "Кейс уже открывается")
    ACTIVE_ACTIONS.add(key)
    try:
        c = CASES.get(body.case_id)
        if not c: raise HTTPException(404, "case not found")
        price = int(c.get("price") or 0)
        if price > 0 and int(u["balance"]) < price:
            raise HTTPException(400, "Недостаточно ⭐")
        now = now_ts()
        if body.case_id == "free_daily" or (price == 0 and not c.get("require_deposit") and not c.get("require_share")):
            if now - int(u["free_case_at"] or 0) < 86400: raise HTTPException(400, "Бесплатный кейс раз в 24ч")
            u["free_case_at"] = now
        if c.get("require_share") or body.case_id == "free_friend":
            if now - int(u["friend_case_at"] or 0) < 43200: raise HTTPException(400, "Кейс за друга раз в 12ч")
            u["friend_case_at"] = now
        if c.get("require_deposit"):
            if int(u["deposited"] or 0) < int(c["require_deposit"]): raise HTTPException(400, "Недостаточный депозит")
        if price: u["balance"] -= price
        drop = roll_case_drop(body.case_id, c)
        u["games"] += 1; u["cases_opened"] = int(u.get("cases_opened") or 0) + 1
        result = {"success": True, "fair": fair_commit(secrets.token_hex(16)), "allin_lose": bool(drop.get("allin_lose"))}
        if drop.get("kind") == "gift":
            g=drop["gift"]; item={k:g[k] for k in ("name","value","rarity","sn","emoji","img") if k in g}; item["id"]=uuid.uuid4().hex[:10]
            u["inventory"].append(item); u["wins"] += 1; result.update(gift=item, rarity=g.get("rarity"))
            await add_history(u["tg_id"], "case", "gift", f"{c.get('name')}: {g.get('name')}", int(g.get("value") or 0)); await push_live(item,u["username"])
        else:
            stars=int(drop.get("stars") or 0); u["balance"] += stars; result.update(stars_earned=stars, gift=None)
            await add_history(u["tg_id"], "case", "win" if stars else "lose", f"{c.get('name')}: ⭐{stars}", stars)
        await save_user(u); await bump_quest(u["tg_id"], "case_3")
        result["balance"] = u["balance"]; return result
    finally:
        ACTIVE_ACTIONS.discard(key)
...
async def mines_start(body: MinesStartRequest, authorization: Optional[str] = Header(None), x_telegram_init_data: Optional[str] = Header(None, alias="X-Telegram-Init-Data")):
    ...
    if u["balance"] < bet:
        raise HTTPException(400, "Недостаточно ⭐")
    # One active Mines round per user; prevents duplicate bets and desyncs.
    for active in MINES_GAMES.values():
        if active.get("tg_id") == u["tg_id"] and not active.get("cashed"):
            raise HTTPException(400, "Сначала заверши текущую игру")
    u["balance"] -= bet
    u["games"] += 1
...
async def mines_cashout(body: MinesCashoutRequest, authorization: Optional[str] = Header(None), x_telegram_init_data: Optional[str] = Header(None, alias="X-Telegram-Init-Data")):
    ...
    return {"win": win, "balance": u["balance"], "mult": round(m, 2), "game_over": True}
    ...
    while True:
        try:
            ...
            while m < CRASH["crash_point"]:
                m = min(CRASH["crash_point"], m * 1.006 + 0.001)
