...
CASES = {
    ...
    'star_case_1': {'name': '⭐ STAR CASE I', 'price': 55, 'category': 'stars', 'icon': '⭐', 'color': 'c-starter', 'star_drops': [15, 25, 35, 45, 55, 85, 125, 210], 'star_weights': [33, 27, 16, 10, 7, 4, 2, 1], 'desc': 'RTP ~72% · редко выше цены'},
    'star_case_2': {'name': '⭐ STAR CASE II', 'price': 110, 'category': 'stars', 'icon': '✨', 'color': 'c-starter', 'star_drops': [25, 45, 65, 90, 115, 175, 285, 460], 'star_weights': [33, 27, 16, 10, 7, 4, 2, 1], 'desc': 'RTP ~72%'},
    'star_case_3': {'name': '⭐ STAR CASE III', 'price': 280, 'category': 'stars', 'icon': '🌟', 'color': 'c-pepe', 'star_drops': [60, 100, 150, 220, 285, 430, 720, 1150], 'star_weights': [33, 27, 16, 10, 7, 4, 2, 1], 'desc': 'RTP ~72%'},
    'star_case_4': {'name': '⭐ STAR CASE IV', 'price': 550, 'category': 'stars', 'icon': '💫', 'color': 'c-tg', 'star_drops': [120, 200, 300, 430, 560, 860, 1420, 2550], 'star_weights': [33, 27, 16, 10, 7, 4, 2, 1], 'desc': 'RTP ~72%'},
...
def calc_upgrade_chance(iv: float, tv: float, bonus: float = 0.0) -> float:
    ...
    raw = (iv / tv) * 100.0
    # x2 ≈ 44% (+2% к прошлому)
    ch = max(0.01, min(74.0, raw * 0.88))
    ch = min(82.0, ch + min(2.0, float(bonus or 0)))
    return round(ch, 2)
...
SLOT_WEIGHTS = [33, 27, 16, 10, 7, 4, 2, 1]  # ещё +~2% к средним/окупу
