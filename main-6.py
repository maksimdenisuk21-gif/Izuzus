...
CASES = {"free_daily": {"name": "🎁 FREE DAILY", "price": 0, "cooldown": 86400, "category": "free", "icon": "🎁", "color": "free", "rarities": ["Common"], "weights": [100], "min_stars": 1, "max_stars": 20, "stars_bias_low": true, "stars_chance": 1.0, "desc": "Раз в 24ч · чаще мало, иногда до 50⭐"}, "star_case_1": {"name": "⭐ STAR CASE I", "price": 55, "category": "stars", "icon": "⭐", "color": "c-starter", "star_drops": [5, 15, 25, 35, 40, 55, 70, 100], "star_weights": [40, 28, 20, 14, 10, 7, 5, 4], "desc": "8 дропов 5–100⭐"}, "star_case_2": {"name": "⭐ STAR CASE II", "price": 110, "category": "stars", "icon": "✨", "color": "c-starter", "star_drops": [10, 25, 40, 60, 80, 120, 180, 250], "star_weights": [40, 28, 20, 14, 10, 7, 5, 4], "desc": "10–250⭐"}, "star_case_3": {"name": "⭐ STAR CASE III", "price": 280, "category": "stars", "icon": "🌟", "color": "c-pepe", "star_drops": [25, 50, 100, 150, 200, 350, 500, 800], "star_weights": [40, 28, 20, 14, 10, 7, 5, 4], "desc": "25–800⭐"}, "star_case_4": {"name": "⭐ STAR CASE IV", "price": 550, "category": "stars", "icon": "💫", "color": "c-tg", "star_drops": [50, 100, 200, 300, 450, 700, 1000, 1500], "star_weights": [40, 28, 20, 14, 10, 7, 5, 4], "desc": "50–1500⭐"}, "nft_starter": {"name": "🌱 NFT STARTER", "price": 220, "category": "nft", "icon": "🌱", "color": "c-starter", "rarities": ["Common", "Uncommon", "Rare"], "weights": [55, 35, 10], "min_stars": 15, "max_stars": 60, "stars_chance": 0.2, "force_names": ["Мишка", "Сердце", "Конфета", "Подарок", "Ракета", "Букет", "Кольцо", "Triple Meow"], "desc": "Чаще 15–100⭐, редко Meow"}, "nft_candy": {"name": "🍭 CANDY NFT", "price": 400, "category": "nft", "icon": "🍭", "color": "c-pepe", "rarities": ["Uncommon", "Rare", "Epic"], "weights": [55, 35, 10], "min_stars": 30, "max_stars": 100, "stars_chance": 0.18, "force_names": ["Конфета", "Candy Cane", "Lol Pop", "Berry Box", "Cookie Heart", "Whip Cupcake", "Love Potion", "Jelly Bunny", "Spy Agaric"], "desc": "Сладкое · EV < цена, иногда 500+"}, "nft_pepe": {"name": "🐸 PEPE BOX", "price": 650, "category": "nft", "icon": "🐸", "color": "c-pepe", "rarities": ["Rare", "Epic", "Legendary"], "weights": [55, 35, 10], "min_stars": 40, "max_stars": 150, "stars_chance": 0.15, "force_names": ["Мишка", "Ракета", "Букет", "Кольцо", "Алмаз", "Jelly Bunny", "Spy Agaric", "Kissed Frog", "Toy Bear"], "desc": "Чаще 15–100, редко топ"}, "nft_magic": {"name": "🔮 MAGIC VAULT", "price": 1000, "category": "nft", "icon": "🔮", "color": "c-frag", "rarities": ["Rare", "Epic", "Legendary"], "weights": [55, 35, 10], "min_stars": 60, "max_stars": 250, "stars_chance": 0.12, "force_names": ["Мишка", "Ракета", "Кольцо", "Hex Pot", "Spy Agaric", "Flying Broom", "Crystal Ball", "Love Potion", "Eternal Rose", "Genie Lamp", "Magic Potion"], "desc": "Чаще 15–100, редко Magic Potion"}, "brand_gucci": {"name": "👜 GUCCI DROP", "price": 900, "category": "brands", "icon": "👜", "color": "c-tg", "rarities": ["Epic", "Legendary"], "weights": [65, 35], "min_stars": 80, "max_stars": 300, "stars_chance": 0.18, "force_names": ["Candy Cane", "Bow Tie", "Snoop Dogg", "Top Hat", "Swag Bag", "Diamond Ring", "Swiss Watch"], "desc": "От 300⭐ · редко Swiss"}, "brand_rolex": {"name": "⌚ ROLEX CASE", "price": 1350, "category": "brands", "icon": "⌚", "color": "c-frag", "rarities": ["Epic", "Legendary", "Mythic"], "weights": [55, 35, 10], "min_stars": 100, "max_stars": 400, "stars_chance": 0.15, "force_names": ["Top Hat", "Bow Tie", "Diamond Ring", "Signet Ring", "Vintage Cigar", "Swiss Watch", "Gem Signet"], "desc": "Чаще среднее, редко Swiss Watch"}, "brand_snoop": {"name": "🐕 SNOOP DROP", "price": 800, "category": "brands", "icon": "🐕", "color": "c-pepe", "rarities": ["Rare", "Epic", "Legendary"], "weights": [55, 35, 10], "min_stars": 60, "max_stars": 250, "stars_chance": 0.18, "force_names": ["Candy Cane", "Snoop Dogg", "Swag Bag", "Snoop Cigar", "Top Hat", "Vintage Cigar", "Low Rider"], "desc": "От 300⭐ · редко Low Rider"}, "only_onyx": {"name": "🖤 ONYX BLACK", "price": 1700, "category": "only_nft", "icon": "🖤", "color": "c-durov", "rarities": ["Epic", "Legendary"], "weights": [65, 35], "stars_chance": 0.0, "force_names": ["Candy Cane", "Lol Pop", "Evil Eye", "Skull Flower", "Top Hat", "Electric Skull", "Neko Helmet", "Voodoo Doll"], "desc": "От 300⭐ · редко Neko/Voodoo"}, "only_crystal": {"name": "💎 CRYSTAL VAULT", "price": 2300, "category": "only_nft", "icon": "💎", "color": "c-frag", "rarities": ["Epic", "Legendary", "Mythic"], "weights": [55, 35, 10], "stars_chance": 0.0, "force_names": ["Spy Agaric", "Cookie Heart", "Crystal Ball", "Flying Broom", "Diamond Ring", "Ion Gem", "Mini Oscar"], "desc": "От 300⭐ · редко Oscar"}, "only_durov": {"name": "🧢 DUROV ONLY", "price": 4000, "category": "only_nft", "icon": "🧢", "color": "c-durov", "rarities": ["Legendary", "Mythic"], "weights": [65, 35], "stars_chance": 0.0, "force_names": ["Top Hat", "Crystal Ball", "Khabib's Papakha", "Diamond Ring", "Mini Oscar", "Heroic Helmet", "Precious Peach"], "desc": "Чаще среднее, микро Pepe/Cap"}, "allin_pepe": {"name": "🐸 ALL-IN PEPE", "price": 45, "category": "allin", "icon": "🐸", "color": "c-pepe", "allin": true, "lose_stars": [0, 1, 2, 3, 5], "lose_weights": [50, 25, 15, 7, 3], "jackpot_name": "Plush Pepe", "jackpot_value": 1000000, "jackpot_chance": 0.0, "desc": "40⭐ · 99.99% ничего · Pepe не падает"}, "allin_rolex": {"name": "⌚ ALL-IN ROLEX", "price": 25, "category": "allin", "icon": "⌚", "color": "c-frag", "allin": true, "lose_stars": [0, 1, 2], "lose_weights": [70, 20, 10], "jackpot_name": "Swiss Watch", "jackpot_value": 50000, "jackpot_chance": 1e-05, "desc": "25⭐ · микрошанс на Rolex"}, "allin_cap": {"name": "🧢 ALL-IN CAP", "price": 65, "category": "allin", "icon": "🧢", "color": "c-durov", "allin": true, "lose_stars": [0, 1, 2, 5], "lose_weights": [55, 25, 12, 8], "jackpot_name": "Durov's Cap", "jackpot_value": 200000, "jackpot_chance": 5e-06, "desc": "60⭐ · микрошанс на Cap"}, "allin_helmet": {"name": "⛑️ ALL-IN HELMET", "price": 90, "category": "allin", "icon": "⛑️", "color": "c-durov", "allin": true, "lose_stars": [0, 1, 3], "lose_weights": [60, 25, 15], "jackpot_name": "Heroic Helmet", "jackpot_value": 150000, "jackpot_chance": 8e-06, "desc": "80⭐ · микрошанс на Helmet"}, "rich_gold": {"name": "👑 GOLD RICH", "price": 1350, "category": "rich", "icon": "👑", "color": "c-durov", "rarities": ["Epic", "Legendary", "Mythic"], "weights": [55, 35, 10], "min_stars": 200, "max_stars": 800, "stars_chance": 0.12, "force_names": ["Candy Cane", "Snoop Dogg", "Evil Eye", "Top Hat", "Crystal Ball", "Diamond Ring", "Swiss Watch"], "desc": "От 300⭐ · редко Swiss"}, "rich_diamond": {"name": "💎 DIAMOND RICH", "price": 2850, "category": "rich", "icon": "💎", "color": "c-frag", "rarities": ["Legendary", "Mythic"], "weights": [65, 35], "min_stars": 400, "max_stars": 1500, "stars_chance": 0.1, "force_names": ["Evil Eye", "Top Hat", "Crystal Ball", "Diamond Ring", "Swiss Watch", "Mini Oscar", "Ion Gem"], "desc": "От 300⭐ · редко Ion"}, "rich_mythic": {"name": "☄️ MYTHIC RICH", "price": 5750, "category": "rich", "icon": "☄️", "color": "c-durov", "rarities": ["Legendary", "Mythic"], "weights": [65, 35], "min_stars": 800, "max_stars": 3000, "stars_chance": 0.08, "force_names": ["Top Hat", "Crystal Ball", "Flying Broom", "Diamond Ring", "Swiss Watch", "Mini Oscar", "Ion Gem", "Heroic Helmet"], "desc": "От 300⭐ · редко Helmet"}, "rich_durov": {"name": "🔥 DUROV RICH", "price": 9200, "category": "rich", "icon": "🔥", "color": "c-durov", "rarities": ["Mythic"], "weights": [100], "min_stars": 1500, "max_stars": 8000, "stars_chance": 0.05, "force_names": ["Crystal Ball", "Diamond Ring", "Swiss Watch", "Mini Oscar", "Ion Gem", "Heroic Helmet", "Precious Peach", "Durov's Cap"], "desc": "От 300⭐ · микро Cap"}, "snoop_pack": {"name": "🐕 SNOOP PACK", "price": 800, "category": "nft", "icon": "🐕", "color": "c-pepe", "force_names": ["Candy Cane", "Lol Pop", "Snoop Dogg", "Swag Bag", "Snoop Cigar", "Top Hat"], "desc": "От 300⭐ · редко Cigar"}, "snake_2025": {"name": "🐍 SNAKE 2025", "price": 500, "category": "nft", "icon": "🐍", "color": "c-starter", "force_names": ["Конфета", "Ёлка", "Candy Cane", "Lunar Snake", "Pet Snake", "Snake Box"], "desc": "Чаще мало, редко Snake"}, "meow_case": {"name": "🐱 MEOW CASE", "price": 400, "category": "nft", "icon": "🐱", "color": "c-starter", "force_names": ["Мишка", "Сердце", "Triple Meow", "Jelly Bunny", "Bunny Muffin", "Toy Bear", "Kissed Frog"], "desc": "Много мишек, иногда Meow/Frog"}, "ramen_drop": {"name": "🍜 RAMEN DROP", "price": 450, "category": "nft", "icon": "🍜", "color": "c-pepe", "force_names": ["Торт", "Подарок", "Instant Ramen", "Vice Cream", "Berry Box", "Whip Cupcake", "Cookie Heart"], "desc": "Еда · дом в плюсе, редко 500+"}, "xmas_case": {"name": "🎄 XMAS CASE", "price": 400, "category": "nft", "icon": "🎄", "color": "c-tg", "force_names": ["Ёлка", "Конфета", "Xmas Stocking", "Candy Cane", "Santa Hat", "Jolly Chimp", "Holiday Drink"], "desc": "НГ · чаще дешёвое, иногда выше цены"}, "float_party": {"name": "🏊 FLOAT PARTY", "price": 400, "category": "nft", "icon": "🏊", "color": "c-starter", "force_names": ["Шампанское", "Торт", "Lol Pop", "B-Day Candle", "Pool Float", "Party Sparkler", "Ice Cream"], "desc": "Праздник · иногда выше 400"}, "starter_plus": {"name": "🌱 STARTER+", "price": 150, "category": "nft", "icon": "🌱", "color": "c-starter", "force_names": ["Мишка", "Сердце", "Конфета", "Подарок", "Ракета", "Букет", "Кольцо", "Алмаз", "Кубок", "Triple Meow"], "desc": "Чаще 15–50⭐, иногда 100, редко Meow"}, "flame_case": {"name": "🔥 FLAME CASE", "price": 900, "category": "nft", "icon": "🔥", "color": "c-durov", "force_names": ["Chill Flame", "Candy Cane", "Spy Agaric", "Crystal Ball", "Flying Broom", "Top Hat"], "desc": "От 300⭐ · редко Broom"}, "bednyy_shkolnik": {"name": "🎒 БЕДНЫЙ ШКОЛЬНИК", "price": 80, "category": "nft", "icon": "🎒", "color": "c-starter", "force_names": ["Мишка", "Сердце", "Конфета", "Подарок", "Ракета", "Букет"], "desc": "Маленький бюджет · чаще 15–50⭐"}, "bogach": {"name": "💼 БОГАЧ", "price": 2500, "category": "rich", "icon": "💼", "color": "c-durov", "force_names": ["Top Hat", "Diamond Ring", "Swiss Watch", "Mini Oscar", "Ion Gem", "Crystal Ball", "Spy Agaric"], "desc": "Дорого · EV < цена, иногда топ"}, "master": {"name": "🎯 МАСТЕР", "price": 1200, "category": "nft", "icon": "🎯", "color": "c-frag", "force_names": ["Кольцо", "Алмаз", "Spy Agaric", "Jelly Bunny", "Crystal Ball", "Flying Broom", "Top Hat", "Love Potion"], "desc": "Средний риск · баланс EV"}, "dep_500": {"name": "🎁 ДЕПО 500", "price": 0, "category": "deposit", "icon": "🎁", "color": "free", "require_deposit": 500, "force_names": ["Мишка", "Сердце", "Конфета", "Подарок", "Ракета", "Букет", "Кольцо", "Triple Meow"], "desc": "За депозит 500⭐ · разово"}, "dep_1000": {"name": "🎁 ДЕПО 1000", "price": 0, "category": "deposit", "icon": "🎁", "color": "free", "require_deposit": 1000, "force_names": ["Мишка", "Конфета", "Кольцо", "Алмаз", "Triple Meow", "Candy Cane", "Lol Pop", "Jelly Bunny"], "desc": "За депозит 1000⭐ · разово"}, "dep_5000": {"name": "🎁 ДЕПО 5000", "price": 0, "category": "deposit", "icon": "💎", "color": "free", "require_deposit": 5000, "force_names": ["Candy Cane", "Lol Pop", "Spy Agaric", "Jelly Bunny", "Crystal Ball", "Top Hat", "Love Potion"], "desc": "За депозит 5000⭐ · разово"}, "dep_15000": {"name": "🎁 ДЕПО 15000", "price": 0, "category": "deposit", "icon": "👑", "color": "free", "require_deposit": 15000, "force_names": ["Top Hat", "Crystal Ball", "Diamond Ring", "Swiss Watch", "Mini Oscar", "Ion Gem", "Spy Agaric"], "desc": "За депозит 15000⭐ · разово"}, "free_friend": {"name": "👥 ЗА ДРУГА", "price": 0, "category": "free", "icon": "👥", "color": "free", "require_share": true, "min_stars": 1, "max_stars": 25, "stars_bias_low": true, "stars_chance": 1.0, "desc": "Поделись ссылкой с другом · 1 раз / 12ч"}, "spider_case": {"name": "🕷️ SPIDER-MAN", "price": 350, "category": "themed", "icon": "🕷️", "color": "c-durov", "theme": "spider", "force_names": ["Мишка", "Сердце", "Конфета", "Ракета", "Кольцо", "Алмаз", "Spy Agaric", "Jelly Bunny", "Lol Pop", "Candy Cane", "Evil Eye", "Top Hat"], "desc": "Паучок · 70% не окуп"}, "batman_case": {"name": "🦇 BATMAN", "price": 420, "category": "themed", "icon": "🦇", "color": "c-tg", "theme": "batman", "force_names": ["Мишка", "Подарок", "Букет", "Кольцо", "Алмаз", "Кубок", "Spy Agaric", "Crystal Ball", "Top Hat", "Electric Skull", "Skull Flower", "Voodoo Doll"], "desc": "Тёмный рыцарь · EV < цена"}, "bobik_case": {"name": "🐶 БОБИК", "price": 180, "category": "themed", "icon": "🐶", "color": "c-starter", "theme": "bobik", "force_names": ["Мишка", "Сердце", "Конфета", "Подарок", "Ракета", "Букет", "Торт", "Кольцо", "Triple Meow", "Jelly Bunny"], "desc": "Собачий кейс · дешёвый"}, "spongebob_case": {"name": "🧽 ГУБКА БОБ", "price": 260, "category": "themed", "icon": "🧽", "color": "c-frag", "theme": "spongebob", "force_names": ["Конфета", "Торт", "Шампанское", "Lol Pop", "Candy Cane", "Berry Box", "Whip Cupcake", "Cookie Heart", "Instant Ramen", "Pool Float"], "desc": "Бикини Боттом · весело"}, "ironman_case": {"name": "🤖 IRON MAN", "price": 900, "category": "themed", "icon": "🤖", "color": "c-durov", "theme": "ironman", "force_names": ["Кольцо", "Алмаз", "Spy Agaric", "Crystal Ball", "Top Hat", "Diamond Ring", "Flying Broom", "Ion Gem", "Swiss Watch", "Mini Oscar"], "desc": "Броня · редко топ"}, "joker_case": {"name": "🃏 JOKER", "price": 550, "category": "themed", "icon": "🃏", "color": "c-pepe", "theme": "joker", "force_names": ["Мишка", "Конфета", "Evil Eye", "Skull Flower", "Electric Skull", "Voodoo Doll", "Spy Agaric", "Top Hat", "Crystal Ball", "Love Potion"], "desc": "Хаос · 70% слив"}, "mario_case": {"name": "🍄 MARIO", "price": 300, "category": "themed", "icon": "🍄", "color": "c-durov", "theme": "mario", "force_names": ["Мишка", "Конфета", "Торт", "Ракета", "Кольцо", "Spy Agaric", "Lol Pop", "Candy Cane", "Cookie Heart", "Berry Box"], "desc": "Грибное королевство"}, "pokemon_case": {"name": "⚡ POKÉMON", "price": 480, "category": "themed", "icon": "⚡", "color": "c-frag", "theme": "pokemon", "force_names": ["Мишка", "Сердце", "Ракета", "Кольцо", "Алмаз", "Jelly Bunny", "Spy Agaric", "Crystal Ball", "Top Hat", "Ion Gem", "Electric Skull"], "desc": "Поймал? EV < цена"}, "naruto_case": {"name": "🍥 NARUTO", "price": 380, "category": "themed", "icon": "🍥", "color": "c-tg", "theme": "naruto", "force_names": ["Мишка", "Конфета", "Подарок", "Кольцо", "Кубок", "Spy Agaric", "Flying Broom", "Crystal Ball", "Top Hat", "Evil Eye"], "desc": "Ниндзя · баланс"}, "freeze_case": {"name": "❄️ FREEZE", "price": 700, "category": "themed", "icon": "❄️", "color": "c-tg", "theme": "freeze", "force_names": ["Кольцо", "Алмаз", "Spy Agaric", "Crystal Ball", "Ice Cream", "Top Hat", "Diamond Ring", "Swiss Watch", "Ion Gem", "Love Potion"], "desc": "Лёд · редко дорогой"}}
...
def calc_upgrade_chance(iv: float, tv: float, bonus: float = 0.0) -> float:
    ...
    if tv <= 0 or iv <= 0:
        return 0.01
    raw = (iv / tv) * 100.0
    ch = max(0.01, min(75.0, raw * 0.85))
    ch = min(90.0, ch + float(bonus or 0))
    return round(ch, 2)
...
def mines_mult(mines: int, opened: int) -> float:
    ...
    for i in range(opened):
        ...
        if safe <= 0:
            break
        mult *= remaining / safe
    return max(1.0, mult * (1 - HOUSE_EDGE))
...
def _parse_init_data(raw: str) -> dict:
    if not raw:
        return {}
    if raw.strip() in ("dev", "Bearer dev"):
    ...
    try:
        ...
        if BOT_TOKEN and hsh:
            data_check.sort()
            data_str = "\n".join(data_check)
            secret = hashlib.sha256(BOT_TOKEN.encode()).digest()
            calc = hmac.new(secret, data_str.encode(), hashlib.sha256).hexdigest()
            if not hmac.compare_digest(calc, hsh):
                if ALLOW_DEV_AUTH:
                    pass  # still try parse user
                else:
        ...
        if user_raw:
            ...
            return {
                ...
                "username": u.get("username") or u.get("first_name") or "Player",
...
def roll_case_drop(case_id: str, c: dict) -> dict:
    ...
    if stars_chance > 0 and random.random() < stars_chance:
        ...
        if c.get("stars_bias_low"):
            # more small
            stars = int(min(hi, max(lo, random.paretovariate(1.4) + lo - 1)))
        else:
    ...
    if rarities:
        ...
        if rar_pool:
            # mix a bit of force names of that rarity
            if pool:
                same = [p for p in pool if p.get("rarity") == r]
                pick_from = (same or pool) + rar_pool[:8]
            else:
                pick_from = rar_pool
            g = random.choice(pick_from)
            return {"kind": "gift", "gift": gift_public(g)}
    if pool:
        g = random.choice(pool)
        return {"kind": "gift", "gift": gift_public(g)}
    # fallback stars
    return {"kind": "stars", "stars": random.randint(5, 40)}
...
async def mines_start(body: MinesStartRequest, authorization: Optional[str] = Header(None), x_telegram_init_data: Optional[str] = Header(None, alias="X-Telegram-Init-Data")):
    ...
    if mines < 2 or mines > 24:
        raise HTTPException(400, "Мины 2–24")
    if u["balance"] < bet:
        raise HTTPException(400, "Недостаточно ⭐")
    u["balance"] -= bet
    u["games"] += 1
    ...
    return {"id": gid, "game_id": gid, "balance": u["balance"], "mult": 1.0}
...
async def mines_open(body: MinesOpenRequest, authorization: Optional[str] = Header(None), x_telegram_init_data: Optional[str] = Header(None, alias="X-Telegram-Init-Data")):
    ...
    if cell in g["bombs"]:
        ...
        return {"bomb": True, "mult": 0, "balance": u["balance"]}
    g["opened"].append(cell)
    m = mines_mult(g["mines"], len(g["opened"]))
    return {"bomb": False, "mult": round(m, 2), "opened": g["opened"]}
...
async def mines_cashout(body: MinesCashoutRequest, authorization: Optional[str] = Header(None), x_telegram_init_data: Optional[str] = Header(None, alias="X-Telegram-Init-Data")):
    ...
    return {"win": win, "balance": u["balance"], "mult": round(m, 2)}
...
async def pvp_list(authorization: Optional[str] = Header(None), x_telegram_init_data: Optional[str] = Header(None, alias="X-Telegram-Init-Data")):
    ...
    for lid, L in list(PVP.items()):
        ...
        view = {
            "id": lid,
            "players": [{**p, "chance": round(100 * p["bet"] / total, 1)} for p in players],
            "pot": total,
        }
        lobbies.append(view)
        if any(p["id"] == u["tg_id"] for p in players):
            mine = view
    return {"lobbies": lobbies, "lobby": mine}
...
async def pvp_start(body: PvpStartRequest, authorization: Optional[str] = Header(None), x_telegram_init_data: Optional[str] = Header(None, alias="X-Telegram-Init-Data")):
    ...
    for p in players:
        ...
        if p is winner:
            ...
            break
        deg_acc += slice_deg
    payout = int(total * (1 - HOUSE_EDGE * 0.3))
    ...
    while True:
        try:
            ...
            while m < CRASH["crash_point"]:
                m = min(CRASH["crash_point"], m * 1.035 + 0.008)
